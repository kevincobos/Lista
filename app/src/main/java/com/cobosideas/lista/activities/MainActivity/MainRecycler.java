...
public class MainRecycler extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private final int CODE_INT_CARD_VIEW_DEFAULT = Constants.CODES_CARD_VIEW_LISTA.CODE_INT_CARD_VIEW_DEFAULT;
    private final int CODE_INT_CARD_VIEW_SIMPLE = Constants.CODES_CARD_VIEW_LISTA.CODE_INT_CARD_VIEW_LINK;
